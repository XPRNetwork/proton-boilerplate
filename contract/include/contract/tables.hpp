...
namespace proton {
   ...
   * ACCOUNT
   */
  struct [[eosio::table, eosio::contract("contract")]] Account {
    eosio::name account;
  ...
  struct [[eosio::table, eosio::contract("contract")]] Plan: public PlanBase {
    uint64_t index;
    uint64_t plan_days;
   ...
   * TERM
   */
  struct [[eosio::table, eosio::contract("contract")]] Term: public PlanBase {
    eosio::name account;
    uint64_t term_days;
