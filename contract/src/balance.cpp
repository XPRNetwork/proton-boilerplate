...
namespace proton {
  void contract::add_balance (const eosio::name& account, const eosio::extended_asset& delta) {
  ...
  void contract::substract_balance (const eosio::name& account, const eosio::extended_asset& delta) {
    // Find account
