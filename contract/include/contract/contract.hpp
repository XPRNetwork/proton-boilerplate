...
namespace proton {
  ...
  public:
    ...
    contract( eosio::name receiver, eosio::name code, eosio::datastream<const char*> ds )
    ...
    // Action wrappers
    using withdraw_action     = eosio::action_wrapper<"withdraw"_n,     &contract::withdraw>;
    using transfer_action     = eosio::action_wrapper<"transfer"_n,     &contract::ontransfer>;
    using delegatebw_action   = eosio::action_wrapper<"delegatebw"_n,   &contract::delegatebw>;
    using undelegatebw_action = eosio::action_wrapper<"undelegatebw"_n, &contract::undelegatebw>;
    using buyrambytes_action  = eosio::action_wrapper<"buyrambytes"_n,  &contract::buyrambytes>;
    using planreceipt_action  = eosio::action_wrapper<"planreceipt"_n,  &contract::planreceipt>;
